...
#define XEMU_ANDROID_SWAPCHAIN_MAX_IMAGES 8
#else
...
#endif
#ifdef __ANDROID__
    VkSurfaceKHR android_surface;
    VkSwapchainKHR swapchain;
    VkFormat swapchain_format;
    VkExtent2D swapchain_extent;
    uint32_t swapchain_image_count;
    VkImage swapchain_images[XEMU_ANDROID_SWAPCHAIN_MAX_IMAGES];
    VkImageView swapchain_image_views[XEMU_ANDROID_SWAPCHAIN_MAX_IMAGES];
    VkImageLayout swapchain_image_layouts[XEMU_ANDROID_SWAPCHAIN_MAX_IMAGES];
    VkSemaphore render_finished;
    VkFence image_acquired_fence;
    bool swapchain_ready;
    uint32_t swapchain_window_generation;
    int present_count;
#endif
